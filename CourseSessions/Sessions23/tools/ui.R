...
heavy computation or traffic on the server, in which case you should simply wait. Plots may at times fade: you do <strong>not</strong> 
    ...
    numericInput("manual_numb_factors_used", "Select Number of Factors to use in the Reports: (the result can be checked at 'Rotated Factors' tab)", 2),
  ...
  mainPanel(
    ...
    tabsetPanel(
      ...
      tabPanel("Unrotated Factors",
               ...
               selectInput("show_colnames_unrotate", "Show variable names?", choices=c("YES","NO"),selected=1, multiple=FALSE),               
               #actionButton("action_unrotated", "Show/Update Results"),
               HTML("<br>"),
               HTML("<br>"),
               tableOutput('Unrotated_Factors')),
      tabPanel("Rotated Factors",
               selectInput("show_colnames_rotate", "Show variable names?", choices=c("YES","NO"),selected=1, multiple=FALSE),               
               #actionButton("action_rotated", "Show/Update Results"),
               HTML("<br>"),
               h5("Showing Factors for the number of factors you selected in the right pane"),
