  ...
  mainPanel(
    ...
    tabsetPanel(
      ...
      tabPanel("Box Plots (Estimation Data Only)",
               ...
               HTML("<br>"),
               div(class="span11",h4("Box Plot")),
               div(class="span11",plotOutput('box_plots'))), 
      ...
      tabPanel("Hit Ratios", 
               ...
               HTML("<hr>"),
               div(class="span11",tableOutput('hit_rates'))), 
      tabPanel("ROC Curves", 
               ...
               HTML("<hr>"),
               div(class="span11",plotOutput('roc_curve'))), 
      tabPanel("Lift Curves", 
               ...
               HTML("<hr>"),
               div(class="span11",plotOutput('lift_curve'))), 
      tabPanel("Profit Curves", 
               ...
               HTML("<hr>"),
               div(class="span11",plotOutput('profit_curve')))
    )    
  )
  ))