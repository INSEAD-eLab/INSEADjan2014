  ...
  mainPanel(
    ...
    tabsetPanel(
      tabPanel("Parameters", 
               ...
               HTML("<br>"),
               div(class="span11",tableOutput('parameters'))), 
      tabPanel("Summary", 
               #actionButton("action_summary", "Show/Update Results"),
               HTML("<br>"),
               div(class="span11",tableOutput('summary'))), 
      tabPanel("Histograms", 
      ...
      tabPanel("Pairwise Distances",
               ...
               HTML("<br>"),
               div(class="span11",h4("Histogram of Pairwise Distances")),
               div(class="span11",plotOutput('dist_histogram')), 
               div(class="span11",tableOutput('pairwise_dist'))), 
      tabPanel("The Dendrogram", 
               #actionButton("action_dendrogram", "Show/Update Results"),               
               HTML("<br>"),
               div(class="span11",plotOutput('dendrogram',  height = "600px"))), 
      tabPanel("The Dendrogram Heights Plot", 
               #actionButton("action_heights", "Show/Update Results"),
               HTML("<br>"),
               div(class="span11",plotOutput('dendrogram_heights',  height = "600px"))), 
      tabPanel("Hclust Membership", 
               #actionButton("action_hclustmemb", "Show/Update Results"),
               HTML("<br>"),
               numericInput("hclust_obs_chosen", "Select the observation to see the  cluster membership for:", 1),
               div(class="span11",textOutput('hclust_membershipt'))),
      tabPanel("Hclust Profiling",
               #actionButton("action_profile", "Show/Update Results"),
               HTML("<br>"),
               div(class="span11",tableOutput('hclust_profiling'))), 
      tabPanel("Kmeans Membership", 
               #actionButton("action_kmeansmemb", "Show/Update Results"),
               HTML("<br>"),
               numericInput("kmeans_obs_chosen", "Select the observation to see the cluster membership for:", 1),
               div(class="span11",textOutput('kmeans_membershipt'))), 
      tabPanel("Kmeans Profiling",
               #actionButton("action_profile", "Show/Update Results"),
               HTML("<br>"),
               div(class="span11",tableOutput('kmeans_profiling'))), 
      tabPanel("Snake Plots", 
               ...
               HTML("<br>"),
               div(class="span11",plotOutput('snake_plot', height = "600px")))
    )    
  )
))